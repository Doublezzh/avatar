...
import com.svw.avatar.utils.AvatarStateUtil;
...
//                            | View.SYSTEM_UI_FLAG_FULLSCREEN // hide status bar
    ...
    protected void onStop() {
        super.onStop();
       AvatarBackgroundMusicManager.getInstance(this).pauseBackgroundMusic();
    }
    ...
    protected void onRestart() {
        ...
        if (!AvatarBackgroundMusicManager.getInstance(this).isBackgroundMusicPlaying()) {
            AvatarBackgroundMusicManager.getInstance(this).resumeBackgroundMusic();
        }
    }
