...
public class Pig {
    ...
    public Pig(Context context, float scale) {
        ...
        Bitmap bitmap = BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_0);
    ...
    private Bitmap[] getDraggingRightBitmaps(Context context) {
        Bitmap bitmap1 = BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_0);
        ...
        return new Bitmap[]{
                BitmapUtil.scaleBitmap(BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_0), width, height),
                bitmap1,
                BitmapUtil.scaleBitmap(BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_0), width, height),
                bitmap1};
    }
    ...
    private Bitmap[] getRunningLeftBitmaps(Context context) {
        return new Bitmap[]{
                ...
                BitmapUtil.scaleBitmap(BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_7), mWidth, mHeight),
                BitmapUtil.scaleBitmap(BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_8), mWidth, mHeight),
                BitmapUtil.scaleBitmap(BitmapUtil.getBitmapFromResource(context, R.mipmap.ic_occupied_left_9), mWidth, mHeight),
