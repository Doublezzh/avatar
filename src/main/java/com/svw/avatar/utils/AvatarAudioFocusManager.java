...
public class AvatarAudioFocusManager {

    private AudioManager audioManager;
    private AudioFocusRequest audioFocusRequest;
    private AvatarAudioFocusChangeListener focusChangeListener;

    public AvatarAudioFocusManager(Context context, AvatarAudioFocusChangeListener listener) {
