...
public class AvatarBackgroundMusicManager {
    private static AvatarBackgroundMusicManager backgroundMusic = null;
    ...
    //单例模式
    private AvatarBackgroundMusicManager(Context context) {
        this.mContext = context;
        initData();
    }
    public static synchronized AvatarBackgroundMusicManager getInstance(Context context) {
        if (backgroundMusic == null) {
            backgroundMusic = new AvatarBackgroundMusicManager(context);
        }
    ...
    public void playBackgroundMusic(int path, boolean isLoop) {
        ...
        if (mBackgroundMediaPlayer == null) {
            LogUtils.e(TAG, "playBackgroundMusic: background media player is null");
        } else {
            ...
            try {
                ...
                LogUtils.e(TAG, "playBackgroundMusic: error state");
            }
        }
    }
    ...
    public void rewindBackgroundMusic() {
        if (mBackgroundMediaPlayer != null) {
            ...
            try {
                ...
                LogUtils.e(TAG, "rewindBackgroundMusic: error state");
            }
        }
    }
